...
export const en: Dictionary = {
  ...
  contactForm: {
    ...
    stepTwo: {
      ...
      Verwaltungssystem: {
        label: "What should the system manage?",
        helper: "(multiple selection possible)",
        options: [
          { key: "Kundenverwaltung / CRM", title: "Customers / CRM", text: "Contacts and cases in one place" },
          { key: "Terminverwaltung", title: "Appointments", text: "Bookings and calendars" },
          { key: "Lagerverwaltung", title: "Inventory", text: "Keep track of stock" },
          { key: "Individuelle Softwarelösung", title: "Custom solution", text: "Tailored to your workflow" },
        ],
      },
    },
    ...
    steps: {
      ...
      booking: {
        ...
        saturdayNote: ["Mon–Fri 5–8 pm.", "Saturday by arrangement only."],
